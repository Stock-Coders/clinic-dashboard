...
@section('title', "{{ $payment->appointment->patient->first_name }}'s Payment (ID: $payment->id)")
@section('content')
          ...
          <div class="card-header">
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-center">
                    Add Last Visit For&nbsp;<span class="text-success fw-bold">{{ $payment->appointment->patient->first_name }}</span>?
                    <a href="{{ route('patients.lastVisitsCreate', $payment->appointment->patient->id) }}"><i class="icofont icofont-meeting-add text-success f-60"></i><i class="icon-hand-point-up f-16"></i></a>
                </div>
                <div class="d-flex align-items-center">
                    Print&nbsp;
                    {{-- <a target="_blank" href="{{ route('payments.show.pdf', $payment->id) }}"><i class="icofont icofont-printer f-40"></i><i class="icon-hand-point-up f-16"></i></a> --}}
                </div>
                <div class="d-flex align-items-center">
                    Add X-ray For&nbsp;<span class="text-warning fw-bold">{{ $payment->appointment->patient->first_name }}</span>?
                    <a href="{{ route('patient.x-rays.create', $payment->appointment->patient->id) }}"><i class="icofont icofont-tooth text-warning f-40"></i><i class="icon-hand-point-up f-16"></i></a>
                </div>
            </div>
            ...
            <strong class="card-title">
                ...
                <p class="fs-5"><span class="text-decoration-underline">Patient ID:</span> <span class="badge rounded-pill badge-dark">{{ $payment->appointment->patient->id }}</span></p>
                <p class="fs-5"><span class="text-decoration-underline">Patient Full Name:</span> <span style="background-color: rgb(235, 235, 235);" class="text-dark fw-bold p-1 rounded">{{ $payment->appointment->patient->first_name .' '. $payment->appointment->patient->last_name }}</span></p>
            </strong>
            <div class="d-flex justify-content-center">
                @php $patientImage = $payment->appointment->patient->image; @endphp
              ...
              <div class="col-md-12">
                ...
                <div class="container-fluid">
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="mb-1">
                            {{-- <a class="text-primary fw-bold text-decoration-underline" href="{{ route('paymentsOfPatient.showIndex', $payment->appointment->patient->id) }}">Click here</a> to see all the <span class="fw-bold">payments</span> of the current patient. --}}
                            Click here to see all the <span class="fw-bold">payments</span> of the current patient.
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body p-0">
                                ...
                                <p class="px-5">
                                    ...
                                    @endif
                                    <br/>
                                    <span class="text-decoration-underline">Treatment's Prescription (ID):</span>
                                    ...
                                    @endif
                                    <br/>
                                    <span class="text-decoration-underline">X-ray (ID):</span>
                                    @if($payment->xray_id)
                                    <a class="fw-bold" href="{{ route('x-rays.show', $payment->xray_id) }}">
                                ...
                                <div class="d-flex justify-content-center p-4">
                                    <div class="alert alert-info text-dark w-100" style="background-color: rgb(247, 242, 207);">
                                        <span>The "<span class="text-decoration-underline fw-bold">Total Cost</span>" will be the total cost of all the following if they are avaiable:</span>
                                        <br/>
                                        <ul style="list-style-type:disc;" class="py-1 px-4">
                                            ...
                                            <li>X-ray (<span class="fw-bold">Optional</span>)</li>
                                        </ul>
                                    </div>
                                </div>
