...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
            <h4 class="card-title">Create X-ray for <a class="text-decoration-underline fw-bold" href="{{ route('patients.show', $patient->id) }}">{{ $patient->first_name . ' ' . $patient->last_name }}</a></h4>
            <div class="col-sm-12 col-xl-12 xl-100">
                <div class="card-header pb-0">
                    <span><a href="{{ route('dashboard') }}">Dashboard</a> / <a href="{{ route('x-rays.index') }}">X-rays</a> / Create X-ray for {{ $patient->first_name . ' ' . $patient->last_name }}</span>
                </div>
                <div class="card-body">
