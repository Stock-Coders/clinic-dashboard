<header class="main-nav">
    <div class="sidebar-user text-center"><a class="setting-primary" href="javascript:void(0)"><i data-feather="settings"></i></a><img class="img-90 rounded-circle" src="{{asset('/assets/dashboard/images/dashboard/1.png')}}" alt="">
      {{-- <div class="badge-bottom"><span class="badge badge-primary">New</span></div> --}}
        <a href="javascript:void(0)">
            <h6 class="mt-3 f-14 f-w-600">{{ auth()->user()->userProfile->name ?? auth()->user()->username }}</h6>
        </a>
        ...
        <div id="mainnav">
          <ul class="nav-menu custom-scrollbar">
            ...
            @elseif (auth()->user()->user_type === "employee")
                <p class="text-dark">Employees Sidebar</p>
            @elseif (auth()->user() && (auth()->user()->user_type !== "doctor" || auth()->user()->user_type !== "employee"))
                {{-- An authenticated user, but the user_type is not "doctor" or "employee"  --}}
                <p class="text-dark">Non-doctor/employee Sidebar</p>
            @endif
          </ul>
        </div>
