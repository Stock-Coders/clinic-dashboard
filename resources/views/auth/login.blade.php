...
<html lang="en">
    ...
    <title>Codex Dental | Login</title>
    <!-- Google font-->
                    ...
                    <div class="card shadow rounded-3">
                        ...
                        <div class="text-center">
                            <div class="alert alert-dark text-center w-75 mx-auto">
                                {{ session()->get('inactivityLogoutMsg') }}
                            </div>
                        </div>
                        @endif
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('dashboard.login') }}">
                                ...
                                <div class="row mb-3">
                                    <label for="email" class="col-md-4 col-form-label text-md-end">{{ __('Username, Email Address or Phone') }} <span class="text-danger">*</span></label>
                                ...
                                <div class="row mb-0">
                                    <div class="col-md-8 offset-md-4">
                                        ...
                                        @endif --}}
                                        {{-- <div class="mt-4">
                                            <a href="{{ route('dashboard.register') }}" class="text-decoration-underline">Don't have an account?</a>
                                        </div> --}}
                                    </div>
                                </div>
                            </form>
